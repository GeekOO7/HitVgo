...
本机 AI 视频创作界面：对接你自己的 RunningHub 或 ComfyUI，支持分镜、素材库与本机助手。

这是**打开即用的单机版**：无登录、无注册、无管理后台、无云存储配额。平台站点请使用官方服务 [https://hitvgo.geek007.com](https://hitvgo.geek007.com)。
...
HitVgo standalone: a local AI video UI for your own RunningHub or ComfyUI (storyboard, asset library, local agent).

No login, no admin, no cloud storage quota. Open `http://127.0.0.1:5000` after:
